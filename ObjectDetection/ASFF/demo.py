...
from utils1.vis_utils import vis
...
def parse_args():
    ...
    parser.add_argument('-c', '--checkpoint',
                        default=r'./save/yolov3_VOC_label_smooth_baseline_mixup_cos_90.pth',
                        type=str,
                        help='pytorch checkpoint file path')
    parser.add_argument('-s', '--test_size', type=int, default=480)
    parser.add_argument('--half', dest='half', action='store_true',
                        default=False,
                        help='FP16 training')
    parser.add_argument('--rfb', dest='rfb', action='store_true',
                        default=False,
                        help='Use rfb block')
    parser.add_argument('--asff', dest='asff', action='store_true',
                        default=False,
...
def demo():
    ...
    for imgName in os.listdir(root_dir):
        ...
        cv2.imwrite(os.path.join('./outputs/',imgName),pred_im)
