...
from utils1.vis_utils import make_vis, make_pred_vis
...
if __name__ == '__main__':
    ...
    with open(r'../config/yolov3_baseline.cfg', 'r') as f:
    ...
    checkpoint = torch.load(r'../save/yolov3_VOC_label_smooth_baseline_mixup_cos_55.pth',map_location='cpu')
    model.load_state_dict(checkpoint)
    ap50_95, ap50  = evaluator.evaluate(model,half=False)
