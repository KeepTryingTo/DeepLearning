...
class Detect(Function):
    ...
    """
    def __init__(self, num_classes, bkg_label, cfg,device):
    ...
    def forward(self, predictions, prior):
        ...
        self.boxes = torch.zeros(1, self.num_priors, 4).to(self.device)
        self.scores = torch.zeros(1, self.num_priors,
        ...
        # Decode predictions into bboxes.TODO 根据生成的anchor对预测结果进行解码操作，也就是转换为真实对应的预测框
        for i in range(num):
