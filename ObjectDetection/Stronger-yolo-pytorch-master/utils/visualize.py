...
def visualize_boxes_and_labels_on_image_array(
  ...
  # print('box_to_color_map: {}'.format(box_to_color_map))
...
def draw_bounding_box_on_image_array(image,
  ...
  draw_bounding_box_on_image(image_pil, ymin, xmin, ymax, xmax, color,
                             thickness, display_str_list,img_name=img_name,
                             use_normalized_coordinates=use_normalized_coordinates)
...
def draw_bounding_box_on_image(image,
  ...
  for display_str in display_str_list[::-1]:
    left_t, top_t, right_t, bottom_t = font.getbbox(display_str)
    text_width, text_height = right_t - left_t, bottom_t - top_t
...
if __name__ == '__main__':
  ...
  visualize_boxes(image=imshow, boxes=_boxes, labels=_labels,
