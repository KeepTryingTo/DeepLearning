...
if __name__ == "__main__":
    ...
    parser.add_argument("--weights_path", type=str, default="./checkpoints/yolo_nano_ckpt_115.pth", help="path to weights file")
    ...
    model = YoloNano(num_class=len(classes),
                     num_anchor=3,
    ...
    for batch_i, (img_paths, input_imgs) in enumerate(dataloader):
        ...
        # TODO Save image and detections
    ...
    for img_i, (path, detections) in enumerate(zip(imgs, img_detections)):
        ...
        # TODO Draw bounding boxes and labels of detections
