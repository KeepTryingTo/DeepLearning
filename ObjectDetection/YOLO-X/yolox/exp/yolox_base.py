...
class Exp(BaseExp):
    def __init__(self):
        ...
        self.data_dir = r'/home/ff/myProject/KGT/myProjects/myDataset/coco'
    ...
    def preprocess(self, inputs, targets, tsize):
        ...
        #TODO 根据指定的大小和当前图像大小计算高宽比，然后进行缩放
    ...
    def get_eval_dataset(self, **kwargs):
        ...
        return COCODataset(
            ...
            name="val2014" if not testdev else "val2014",
    ...
    def eval(self, model, evaluator, is_distributed,
             half=False, return_outputs=False):
