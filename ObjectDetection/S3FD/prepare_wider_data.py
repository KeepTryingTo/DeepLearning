...
WIDER_ROOT = cfg.HOME
train_list_file = os.path.join(WIDER_ROOT,'wider_face_train_bbx_gt.txt')
val_list_file = os.path.join(WIDER_ROOT,'wider_face_val_bbx_gt.txt')

WIDER_TRAIN = os.path.join(WIDER_ROOT,'WIDER_train', 'WIDER_train', 'images')
WIDER_VAL = os.path.join(WIDER_ROOT,'WIDER_val', 'WIDER_val', 'images')
