...
parser.add_argument('-m', '--trained_model',
                    default='./runs/Final_RFB_vgg_VOC.pth', #Final_RFB_vgg_VOC.pth
...
"""
VOC2007 test(RFBNet300_VOC_80_7.pth)
    iou_thresh=0.005,conf_threshod = 0.2 MAP = 0.6988
    iou_thresh=0.005,conf_threshod = 0.005 MAP = 0.7173
    
VOC2012 trainval.txt and test on 2007 test.txt
