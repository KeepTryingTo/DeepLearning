...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_folder',
                        default='/home/ff/myProject/KGT/myProjects/myProjects/Pytorch_Retinaface-master/data/WIDERFACE/widerface/val/images', type=str, help='dataset path')
    parser.add_argument('--folder_pict',
                        default='/home/ff/myProject/KGT/myProjects/myProjects/Pytorch_Retinaface-master/data/WIDERFACE/widerface/val/wider_val.txt',
