...
parser.add_argument('--trained_model',
                    default='../work_dir/SSD300_VOC_FPN_Giou/giou_ssd_fpn_240.pth', type=str,
...
def test_net(save_folder, net, device, dataset,
             top_k,im_size=300, thresh=0.05):
    #the len of pic
...
if __name__ == '__main__':
    ...
    all_boxes = test_net(args.save_folder, net,
                         device, dataset,args.top_k, im_size=300,
