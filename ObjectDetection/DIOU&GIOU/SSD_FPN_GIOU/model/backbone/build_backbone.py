...
class Backbone(nn.Module):
    ...
    def add_extras(self,lay,in_channel):
        exts1 = nn.Sequential(
            ConvModule(2048,256,1,
                       normalize=None,stride = 1,
                bias=True),
            ConvModule(256,512,3,
                       normalize=None,stride = 2,padding = 1,
                bias=True)
        ...
        exts2 = nn.Sequential(
            ConvModule(512,128,1,
                       normalize=None,stride = 1,
                bias=True),
            ConvModule(128,256,3,
                       normalize=None,stride = 2,padding = 1,
                bias=True)
        ...
        exts3 = nn.Sequential(
            ConvModule(256,128,1,
                ...
                bias=True),
            ConvModule(128,256,3,
                       normalize=None,stride = 1,padding = 0,
                bias=True)
            )
