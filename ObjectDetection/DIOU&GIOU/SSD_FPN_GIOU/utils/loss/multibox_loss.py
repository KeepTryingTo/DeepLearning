...
class MultiBoxLoss(nn.Module):
    ...
    def __init__(self, cfg, overlap_thresh, prior_for_matching,
                 ...
                 device,loss_c = "CrossEntropy", loss_r = 'SmoothL1'):
        ...
        self.focalloss = FocalLoss(self.num_classes,
                                   gamma=2,
                                   size_average = False)
        self.gious = GiouLoss(pred_mode = 'Center',
                              size_sum=True,
    ...
    def forward(self, predictions, targets):
        ...
        for idx in range(num):
            ...
            if self.loss_r == 'SmoothL1':
                ...
                match_gious(self.threshold, truths,
        ...
        if self.loss_r == 'SmoothL1':
            ...
            loss_l = self.gious(loc_p,loc_t,
                                giou_priors[pos_idx].view(-1, 4)
                                )
