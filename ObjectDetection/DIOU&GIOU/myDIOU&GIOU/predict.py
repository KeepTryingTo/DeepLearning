...
save = r'D:\conda3\Transfer_Learning\ObjectDetect\DIOU\myselfDIOU\outputs'
weight_path = r'weights/40_0.1962_model.pth'
device = torch.device("cpu" if torch.cuda.is_available() else "cpu")

# from torchvision.ops import diou_loss,generalized_box_iou,ciou_loss
