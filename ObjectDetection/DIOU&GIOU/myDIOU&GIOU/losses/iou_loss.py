...
## GIOU losses is proposed here: https://arxiv.org/abs/1902.09630
...
## DIOU losses is proposed here: https://arxiv.org/abs/1911.08287
...
## CIOU losses is also proposed here: https://arxiv.org/abs/1911.08287
...
def giou_func(gt_bboxes, pr_bboxes, eps=1e-5):
    ...
    union = gt_bboxes[:,:2] * gt_bboxes[:,:2] + pr_bboxes[:,:2] * pr_bboxes[:,:2]
...
if __name__ == '__main__':
    ...
    #  losses = generalized_iou_loss(gt_bbox, pr_bbox, reduction='none')
    #  print(losses)
