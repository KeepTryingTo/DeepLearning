...
def vis_bbox(
        ...
        sigma=[],
        sigma_scale_img=(1.0, 1.0),
        sigma_scale_xy=3.0,
        sigma_scale_wh=3.0,
        show_inner_bound=False,
        alpha=1.,
        linewidth=1.,
        ax=None
):
    ...
    Args:
        ...
        sigma_scale_img (list of float): TODO “用于可视化 xy 不确定性的缩放因子。
                                            这可以补偿每个 x 和 y 轴 sigma 的图像缩放。”
