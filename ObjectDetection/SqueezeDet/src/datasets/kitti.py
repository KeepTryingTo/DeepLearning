...
from src.utils.boxes import generate_anchors
...
class KITTI(BaseDataset):
    def __init__(self, phase, cfg):
        ...
        #TODO 图像最终的下采样之后大小，其实也就是对原图进行网格的划分
        ...
        for res in results:
            ...
            if 'class_ids' not in res:
                with open(txt_path, 'w') as fp:
                    fp.write('')
                continue
            image_id = res['image_meta']['image_id']
    ...
    def evaluate(self):
        kitti_eval_tool_path = os.path.join(r'/data1/KTG/myProject/SqueezeDet-PyTorch-master',
                                            'src/utils/kitti-eval/cpp/evaluate_object')
