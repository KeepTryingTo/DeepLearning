...
class Config(object):
    def __init__(self):
        ...
        self.parser.add_argument('--load_model',
                                 default=r'/data1/KTG/myProject/SqueezeDet-PyTorch-master/models/imagenet/squeezenet1_1-f364aa15.pth',
                                 # default=r'/data1/KTG/myProject/SqueezeDet-PyTorch-master/models/imagenet/squeezenet1_0-a815701f.pth',
        ...
        self.parser.add_argument('--no_eval', type=bool,default=False,
        ...
        self.parser.add_argument('--forbid_resize',type=bool,default=False,
    ...
    def parse(self, args=''):
        ...
        cfg.root_dir = r'/data1/KTG/myDataset/KITTI'
        cfg.data_dir = os.path.join(cfg.root_dir, 'data')
        cfg.exp_dir = os.path.join(cfg.root_dir, 'exp')
        cfg.save_dir = r'/data1/KTG/myProject/SqueezeDet-PyTorch-master/runs'
