...
def assign_priors(gt_boxes, gt_labels, corner_form_priors,
    ...
    # size: num_targets: (num_targets,);(num_targets,)对应num_targets个标注框的几个最好的prior anchors
    ...
    best_target_per_prior.index_fill_(dim = 0, index=best_prior_per_target_index, value=2)
