...
class RegionProposalNetwork(nn.Module):
    ...
    def __init__(
        ...
        #TODO 根据anchor尺度以及anchor box的比率生成对应的anchor box[xmin,ymin,xmax,ymax]
        self.anchor_base = generate_anchor_base(
            anchor_scales=anchor_scales,
            ratios=ratios
        )
        self.feat_stride = feat_stride
        #TODO 默认proposal_creator_params为空
    ...
    def forward(self, x, img_size, scale=1.):
        ...
        """
        n, _, hh, ww = x.size()
        # TODO 生成anchor box Generate anchors throughout the image.
        ...
        # TODO 进行box的裁剪以及NMS算法流程 Map the scales and translates to the rois.
