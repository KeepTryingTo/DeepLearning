...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--load_model',
                             default='/home/ff/myProject/KGT/myProjects/myDataset/coco/exp/ctdet/default/model_best.pth',
                             # default='',
    ...
    self.parser.add_argument('--not_cuda_benchmark', type=bool,default=True,
    ...
    # train
    self.parser.add_argument('--lr', type=float, default=0.0000625,
                             help='b = 32 -> 0.000125 learning rate for batch size 32.')
    ...
    self.parser.add_argument('--trainval', type=bool,default=False,
                             help='include validation in training and '
                                  'test on test set')

    # test
    self.parser.add_argument('--flip_test',type=bool,default=False,
                             help='flip data augmentation.')
    self.parser.add_argument('--test_scales', type=str, default='1',
                             help='multi scale test augmentation.')
    self.parser.add_argument('--nms', type=bool,default=True,
                             help='run nms in testing.')
    self.parser.add_argument('--K', type=int, default=100,
                             help='max number of output objects.') 
    self.parser.add_argument('--not_prefetch_test',type=bool,default=True,
                             help='not use parallal data pre-processing.')
    #TODO fix_res
    self.parser.add_argument('--fix_res',type=bool,default=True,
                             help='fix testing resolution or keep '
                                  'the original resolution')
    self.parser.add_argument('--keep_res',type=bool,
                             default=False,
                             help='keep the original resolution'
                                  ' during validation.')
    self.parser.add_argument('--hm_gauss', type=int,default=4,
                             help='keep the original resolution'
                                  ' during validation.')
    # dataset
    self.parser.add_argument('--not_rand_crop',type=bool,
                             default=False,
    ...
    self.parser.add_argument('--no_color_aug', type=bool,default=True,
    ...
    self.parser.add_argument('--rect_mask', type=bool,default=False,
    ...
    # loss
    self.parser.add_argument('--mse_loss', type=bool,default=False,
    ...
    #TODO cat_spec_wh 和 cat_spec_wh
  ...
  def parse(self, args=''):
    ...
    opt.root_dir = r'/home/ff/myProject/KGT/myProjects/myDataset/coco'
    # opt.data_dir = os.path.join(opt.root_dir, 'coco2014')
  ...
  def update_dataset_info_and_set_heads(self, opt, dataset):
    ...
    if opt.task == 'exdet':
      ...
      # TODO assert opt.dataset in ['pascal', 'coco'] 默认进入这里
