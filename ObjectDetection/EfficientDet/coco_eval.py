...
from utiles.utils import postprocess,invert_affine,preprocess
# from utils.utils import preprocess, invert_affine, postprocess, boolean_string

ap = argparse.ArgumentParser()
ap.add_argument('-p', '--project',
                type=str, default='coco', help='project file that contains parameters')
ap.add_argument('-c', '--compound_coef',
                type=int, default=0, help='coefficients of efficientdet')
ap.add_argument('-w', '--weights',
                type=str,
                default=r'./logs/coco/efficientdet-d0_4_9500.pth',
                help='/path/to/weights')
ap.add_argument('--nms_threshold',
                type=float, default=0.5, help='nms threshold, don\'t change it if not for testing purposes')
...
if __name__ == '__main__':
    ...
    VAL_GT = f'/home/ff/myProject/KGT/myProjects/myDataset/coco/captions/annotations/instances_val2014.json'
    VAL_IMGS = f'/home/ff/myProject/KGT/myProjects/myDataset/coco/val2014/val2014/'
    MAX_IMAGES = 10000
    coco_gt = COCO(VAL_GT)
