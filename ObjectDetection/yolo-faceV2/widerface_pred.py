...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_folder', default='/home/ff/myProject/KGT/myProjects/myDataset/wider_face/WIDER_val/WIDER_val/images', type=str, help='dataset path')
    parser.add_argument('--folder_pict', default='', type=str, help='folder_pict')
    opt = parser.parse_args()
    print(opt)

    # changhy : read folder_pict
    pict_folder = {} #TODO 原图像名称和现在图像名称之间的映射关系
