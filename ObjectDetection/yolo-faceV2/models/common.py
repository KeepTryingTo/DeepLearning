...
class TridentBlock(nn.Module):
    def __init__(self, c1, c2, stride=1, c=False, e=0.5,
                 padding=[1, 2, 3], dilate=[1, 2, 3],
                 bias=False):
    ...
    def forward_for_small(self, x):
        ...
        out = nn.functional.conv2d(out, self.share_weightconv2,
...
class MultiSEAM(nn.Module):
    def __init__(self, c1, c2, depth, kernel_size=3,
                 patch_size=[3, 5, 7],
                 reduction=16):
