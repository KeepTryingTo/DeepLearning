    ...
    try:
        ...
        if dsat != 1 or dexp != 1 or dhue != 0:
            if img.shape[2] >= 3:
                ...
                #TODO cv2.split()出来的hsv是tuple，不能被赋值的，转换成list就好了 https://github.com/Tianxiaomo/pytorch-YOLOv4/issues/427
...
class Yolo_dataset(Dataset):
    def __init__(self, label_path, cfg, train=True):
        ...
        #====================================================
        print(label_path)
        print('width: {}  height: {}'.format(cfg.w, cfg.h))
        #====================================================
    ...
    def __getitem__(self, index):
        ...
        for i in range(use_mixup + 1):
            ...
            ai = image_data_augmentation(img, self.cfg.w, self.cfg.h, pleft, ptop,
                                         swidth, sheight, flip,
