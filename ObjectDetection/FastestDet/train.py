...
class FastestDet:
    def __init__(self):
        ...
        parser.add_argument('--weight', type=str,
                            default=r'./weights/weight_AP05_0.253207_280-epoch.pth', help='.weight config')
        ...
        # 数据集加载
        val_dataset = TensorDataset(self.cfg.val_txt,
                                    self.cfg.input_width,
                                    self.cfg.input_height, False)
        train_dataset = TensorDataset(self.cfg.train_txt,
                                      self.cfg.input_width,
                                      self.cfg.input_height, True)
...
"""
epoch = 0 & weight = weight_AP05_0.253207_280-epoch.pth
...
epoch = 10 & weight = weight_AP05_0.253207_280-epoch.pth
