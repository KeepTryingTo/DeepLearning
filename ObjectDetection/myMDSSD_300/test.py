...
from data import (AnnotationTransform, VOCDetection,
                  BaseTransform, VOC_300,VOC_512,COCO_300,COCO_512)
...
from myMDSSD_300.data.coco import COCODetection

parser = argparse.ArgumentParser(description='Receptive Field Block Net')

parser.add_argument('-v', '--version', default='mdssd',
                    help='mdssd or fssd version.')
parser.add_argument('-s', '--size', default='300',
                    help='300 or 512 input size.')
parser.add_argument('-d', '--dataset', default='COCO',
                    help='VOC or COCO version')
parser.add_argument('-m', '--trained_model',
                    default='./runs/mdssd_COCO_epoches_100.pth', #Final_RFB_vgg_VOC.pth
...
if __name__ == '__main__':
    ...
    if args.dataset == 'VOC':
        ...
        print("COCO root: {}".format(COCOroot))
    ...
    test_net(save_folder, net,
             detector, args.cuda,
             testset,
             BaseTransform(net.input_size, rgb_means, (2, 0, 1)),
             top_k,
