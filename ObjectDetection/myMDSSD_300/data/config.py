...
#RFB CONFIGS
VOC_300 = {
    'feature_maps' : [75, 38, 19, 10, 5, 3, 1], #TODO 表示网络最后输出的特征图大小，分别用于检测小目标 -> 大目标
    'min_dim' : 300,#TODO 图像最小尺寸
    'steps' : [4, 8, 16, 32, 64, 100, 300], #TODO 表示和上面特征图输出大小对应的下采样步长
    'min_sizes' : [15, 30, 60, 111, 162, 213, 264],#TODO 可以发现最小和最大值之间是错开的
    'max_sizes' : [30, 60, 111, 162, 213, 264, 315], #TODO

    'aspect_ratios' : [[2],[2], [2], [2, 3], [2, 3], [2], [2]], #TODO anchor的高宽比，分别对应输出的6个特征图上的anchor高宽比
...
VOC_512= {
    ...
    'aspect_ratios' : [[2], [2], [2], [2, 3], [2,3], [2], [2]],
...
COCO_300 = {
    ...
    'min_sizes' : [10, 21, 45, 99, 153, 207, 261],

    'max_sizes' : [21, 45, 99, 153, 207, 261, 315],
