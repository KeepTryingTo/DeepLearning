...
from myMDSSD_300.utils.pycocotools.coco import COCO
from myMDSSD_300.utils.pycocotools.cocoeval import COCOeval
# from myMDSSD_300.utils.pycocotools import mask as COCOmask
...
class COCODetection(data.Dataset):
    ...
    def __init__(self, root, image_sets, preproc=None, target_transform=None,
        ...
        self._view_map = {
            'train2014' : 'train2014',          # 5k val2014 subset
            'val2014' : 'val2014',  # val2014 \setminus minival2014
    ...
    def _get_ann_file(self, name):
        ...
        return os.path.join(self.root, 'captions/annotations',
                        prefix + '_' + name + '.json')
