...
parser.add_argument('-v', '--version', default='mdssd',help='fssd ,'
                                    'fssd or mdssd version.')
...
parser.add_argument('-m', '--trained_model',
                    default=r'runs/mdssd_COCO_epoches_120.pth',
                    type=str, help = 'Trained state_dict file path to open')
parser.add_argument('--save_folder', default='./outputs', type=str,help='Dir to save results')
