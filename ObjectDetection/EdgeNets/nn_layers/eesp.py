...
class EESP(nn.Module):
    ...
    def __init__(self, nIn, nOut, stride=1, k=4, r_lim=7, down_method='esp'): #down_method --> ['avg' or 'esp']
        ...
        for i in range(k):
            ksize = int(3 + 2 * i)
            # TODO After reaching the receptive field limit, fall back to the base kernel size of 3 with a dilation rate of 1
    ...
    def forward(self, input):
        ...
        # TODO Reduce --> project high-dimensional feature maps to low-dimensional space
        output1 = self.proj_1x1(input)
        output = [self.spp_dw[0](output1)]
        # TODO compute the output for each branch and hierarchically fuse them
