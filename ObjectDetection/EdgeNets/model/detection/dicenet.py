...
class SSDNet300(nn.Module):
    ...
    def __init__(self, args, extra_layer):
        ...
        config = base_net_config[:5]

        # TODO add configuration for SSD version
        config += [1024, 512, 256]

        # =============================================================
        #                EXTRA LAYERS for DETECTION
        # =============================================================
        print('base net config: {}'.format(base_net_config))
        ...
        self.bu_3x3_5x5 = EfficientPyrPool(in_planes=in_features,
                                           proj_planes=out_features // red_factor,
    ...
    def up_sample(self, x, size):
        return F.interpolate(x, size=(size[2], size[3]),
    ...
    def forward(self, x, is_train=True):
        ...
        #TODO out_10x10.shape: torch.Size([1, 976, 10, 10])
        # print('out_10x10.shape: {}'.format(out_10x10.size()))
        ...
        return (out_38x38_epp, out_19x19_epp,
                out_10x10_epp, out_5x5_epp,
                out_3x3, out_1x1)
