...
def main(args):
    ...
    target_transform = MatchPrior(center_form_priors=PriorBox(cfg)(),
                                  center_variance=cfg.center_variance,
                                  size_variance=cfg.size_variance,
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        train_loss, train_cl_loss, train_loc_loss = train(
