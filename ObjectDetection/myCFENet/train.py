...
import time
from myCFENet.data.coco import COCODetection
...
parser.add_argument('-v', '--version', default='cfenet',
                    help='myFeature_FSSD_Vgg or cfenet version.')
parser.add_argument('-s', '--size', default='300',help='300 or 512 input size.')
parser.add_argument('-d', '--dataset',
                    default='COCO',
                    help='VOC or COCO dataset')
parser.add_argument('--basenet',
                    default='/home/ff/myProject/KGT/myProjects/myProjects/PyTorch_Object_Detection-master/myMDSSD_300/weights/vgg16_reducedfc.pth',
...
rgb_means = ((104, 117, 123),(103.94,116.78,123.68))[args.version == 'cfenet']
p = (0.6,0.2)[args.version == 'cfenet']
#TODO 类别数，batch大小
...
if args.resume_net == None  and args.version == 'myFeature_FSSD_Vgg':
...
if args.resume_net == None and args.version == 'cfenet':
    base_weights = torch.load(args.basenet,map_location='cpu')
    ...
    # TODO create new OrderedDict that does not contain `module.`
    from collections import OrderedDict
