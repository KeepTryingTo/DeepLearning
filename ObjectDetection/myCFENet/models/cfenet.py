...
from myCFENet.models.multibox_layer import MultiBoxLayer
from myCFENet.models.util import CFE, FFB
...
if __name__ == '__main__':
    ...
    net = CFENet(num_classes=21)
    outs = net(t)
    """
        out.shape: torch.Size([1, 8732, 4])
        out.shape: torch.Size([1, 8732, 21])
    """
    for out in outs:
