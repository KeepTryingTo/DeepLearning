...
from myMDSSD_300.models.base_models import vgg, vgg_base
...
class FSSD(nn.Module):
    ...
    def __init__(self, base, extras, ft_module,
                 pyramid_ext, head, num_classes, size):
    ...
    def forward(self, x, test=False):
        ...
        # TODO 融合模块 apply extra layers and cache source layer outputs
...
#TODO FSSD中拼接起来的那三层，也就是VGG的最后那几层
...
def build_net(size=300, num_classes=21):
    ...
    return FSSD(
        *feature_transform_module(
            vgg(vgg_base[str(size)], 3),
