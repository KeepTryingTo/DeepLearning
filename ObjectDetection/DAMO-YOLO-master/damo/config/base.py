...
train = easydict({
    ...
    'resume_path': r'/home/ff/myProject/KGT/myProjects/myProjects/DAMO-YOLO-master/tools/workdirs/damoyolo_tinynasL20_T/epoch_25_ckpt.pth',           # ckpt path for resuming training
...
dataset = easydict({
    ...
    'train_ann': ('coco_2014_train', ),
    'val_ann': ('coco_2014_val', ),
    'data_dir': r'/home/ff/myProject/KGT/myProjects/myDataset/coco',
