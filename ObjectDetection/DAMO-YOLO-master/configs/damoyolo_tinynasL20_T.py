...
class Config(MyConfig):
    def __init__(self):
        ...
        self.dataset.train_ann = ('coco_2014_train', )
        self.dataset.val_ann = ('coco_2014_val', )

        # backbone
        structure = self.read_structure(
            '/home/ff/myProject/KGT/myProjects/myProjects/DAMO-YOLO-master/damo/base_models/backbones/nas_backbones/tinynas_L20_k1kx.txt')
        TinyNAS = {
            'name': 'TinyNAS_res',
        ...
        self.dataset.class_names = ['person', 'bicycle', 'car', 'motorcycle', 'airplane',
