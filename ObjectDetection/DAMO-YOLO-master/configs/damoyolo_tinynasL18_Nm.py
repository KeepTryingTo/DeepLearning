...
class Config(MyConfig):
    def __init__(self):
        ...
        self.dataset.train_ann = ('train2014', )
        self.dataset.val_ann = ('val2014', )

        # backbone
        structure = self.read_structure(
            '/home/ff/myProject/KGT/myProjects/myProjects/DAMO-YOLO-master/damo/base_models/backbones/nas_backbones/tinynas_nano_middle.txt')
        TinyNAS = {
            'name': 'TinyNAS_mob',
