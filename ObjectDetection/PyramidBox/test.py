...
print('Loading model..')
ssd_net = build_sfd('test', size=640, num_classes=2)
net = ssd_net
net.load_state_dict(torch.load('./weights/Res50_pyramid_95000.pth',map_location='cpu'))
net.cuda()
net.eval()
...
if __name__ == '__main__':
    ...
    if subset is 'val':
        wider_face = sio.loadmat(
            '/home/ff/myProject/KGT/myProjects/myDataset/wider_face/wider_face_val.mat')    # Val set
    else:
        wider_face = sio.loadmat(
            '/home/ff/myProject/KGT/myProjects/myDataset/wider_face/wider_face_test.mat')   # Test set
    event_list = wider_face['event_list']
    file_list = wider_face['file_list']
    del wider_face

    Path = '/home/ff/myProject/KGT/myProjects/myDataset/wider_face/WIDER_val/WIDER_val/images/'
    save_path = '/home/ff/myProject/KGT/myProjects/myProjects/PyramidBox-master/runs' + '_' + subset + '/'
