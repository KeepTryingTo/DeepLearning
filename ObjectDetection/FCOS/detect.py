...
if __name__=="__main__":
    ...
    model=FCOSDetector(mode="inference",config=Config, device=device)
    ...
    for name in names:
        ...
        for i,box in enumerate(boxes):
            ...
            bbox = patches.Rectangle((box[0],box[1]),width=box[2]-box[0],
                                     height=box[3]-box[1],linewidth=1,
        ...
        plt.savefig('outputs/{}'.format(name), bbox_inches='tight', pad_inches=0.0)
        plt.close()
