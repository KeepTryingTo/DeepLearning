...
parser.add_argument('--basenet',
                    default=r'/home/ff/myProject/KGT/myProjects/myProjects/RFBNet-master/weights/vgg16_reducedfc.pth',
...
def train():
    ...
    refinedet_net = build_refinedet(phase='train', size=cfg['min_dim'],
    ...
    arm_criterion = RefineDetMultiBoxLoss(num_classes=2, overlap_thresh=0.5,
                                          ...
                                          neg_mining=True, neg_pos=3, neg_overlap=.5,
                                          encode_target=False, device=device,use_ARM=False)
    odm_criterion = RefineDetMultiBoxLoss(num_classes=cfg['num_classes'], overlap_thresh=0.5,
                                          prior_for_matching=True, bkg_label=0,
...
def update_vis_plot(iteration, loc, conf,
                    window1, window2,
                    update_type,
                    epoch_size=1):
    viz.line(
