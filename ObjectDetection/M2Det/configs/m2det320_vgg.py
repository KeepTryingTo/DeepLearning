model = dict(
    ...
    input_size = 320,
    init_net = True,
    pretrained = '/home/ff/myProject/KGT/myProjects/myProjects/Feature-Fused SSD/weights/vgg16_reducedfc.pth',
    m2det_config = dict(
        backbone = 'vgg16',
        net_family = 'vgg', # vgg includes ['vgg16','vgg19'], res includes ['resnetxxx','resnextxxx']
        base_out = [22,34], #TODO  [22,34] for vgg, [2,4] or [3,4] for res families
        planes = 256,
        num_levels = 8,
        num_scales = 6,
        sfam = False,
...
train_cfg = dict(
    ...
    # per_batch_size = 8,
    # lr = [0.002, 0.001, 0.0002, 0.00002, 0.000002],
    per_batch_size = 4,
...
COCOroot = r'E:\conda_3\PyCharm\Transer_Learning\MSCOCO\coco'
