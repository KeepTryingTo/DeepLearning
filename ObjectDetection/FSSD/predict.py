...
parser.add_argument('-v', '--version', default='myFeature_FSSD_Mobilenet',help='RFB_vgg ,'
                                    'myFeature_FSSD_Vgg or myFeature_FSSD_Mobilenet version.')
...
parser.add_argument('-m', '--trained_model',
                    default=r'runs/myFeature_FSSD_Mobilenet_VOC_epoches_255.pth',
