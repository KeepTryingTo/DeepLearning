...
# from dsod.dsod import DSOD
from models.vovnet import VOVNet
...
parser = argparse.ArgumentParser(description='VOVNet Training')
parser.add_argument('-c', '--config', default='configs/vovnet_VOC.py')
...
print_info('----------------------------------------------------------------------\n'
           '|                       VOVNet Training Program                       |\n'
           '----------------------------------------------------------------------', ['yellow', 'bold'])
#TODO 加载日志logger
logger = set_logger(args.tensorboard)
#TODO 加载配置文件
cfg = Config.fromfile(args.config)
net = VOVNet(num_classes=21,
             num_anchors=cfg.model.anchor_config.anchor_nums,
...
if __name__ == '__main__':
    ...
    max_iter = cfg.train_cfg.step_lr[-1] * 100
