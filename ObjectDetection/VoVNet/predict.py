...
parser = argparse.ArgumentParser(description='VOVNet Evaluation')
parser.add_argument(
    '-c', '--config', default='configs/vovnet_VOC.py', type=str)
parser.add_argument('-d', '--dataset', default='VOC',
                    help='VOC or COCO version')
parser.add_argument('-m', '--trained_model',
                    default=r'./weights/VOC/vovnet_VOC_size300_epoch810.pth',
...
def predictImage(conf_thresh = 0.35):
    ...
    for img_name in img_list:
        ...
        for j in range(1, num_classes):
            ...
            # keep = nms(c_bboxes, c_scores, iou_threshold=0.01)
        ...
        for i,box in enumerate(boxes):
            ...
            if confidence > conf_thresh:
                ...
                text = "{} {}%".format(VOC_CLASSES[int(label) - 1], round(confidence * 100, 2))
                cvzone.putTextRect(
