...
def parse_args():
    ...
    parser.add_argument('--img',type=str,default=r'../images',
    ...
    parser.add_argument('--checkpoint',
                        type=str,
                        default=r'/home/ff/myProject/KGT/myProjects/myProjects/YOLO-MS-main/tools/work_dirs/yoloms-s_syncbn_fast_8xb8-300e_coco/epoch_80.pth',
