...
flags.DEFINE_string('device', '1', 'cuda device, i.e. 0 or 0,1,2,3 or cpu')
...
flags.DEFINE_string('save_dir',
                    default=r'/home/ff/myProject/KGT/myProjects/myProjects/ObjectBox-master',
                    help='save results')
...
flags.DEFINE_string('source', str(ROOT/'images'), 'file/dir/URL/glob/screen/0(webcam)')  ###
