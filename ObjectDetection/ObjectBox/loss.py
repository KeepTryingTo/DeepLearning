...
class ComputeLoss:
    ...
    def __call__(self, p, targets):  # predictions, targets, model
        ...
        for i, pi in enumerate(p):  # layer index, layer predictions
            ...
            if n:
                ...
                # TODO 对预测的结果p0,p1,p2,p3进行转换得到结果[L,R,T,B]Regression
                ...
                if self.sort_obj_iou:
                    ...
                    b_1, a_1, gj_1, gi_1, score_iou_center = (b_1[sort_id_1],
                                                              a_1[sort_id_1],
                                                              gj_1[sort_id_1],
                                                              gi_1[sort_id_1],
                                                              score_iou_center[sort_id_1])
    ...
    def build_targets(self, p, targets):
        ...
        nt = targets.shape[0]  # TODO 当前batch包含的物体数
        ...
        targets_b = torch.cat((targets.repeat(num_nobox, 1, 1),
                               ai[:, :, None]), dim = 2)  #
...
def sd_iou(box1, box2, x1y1x2y2=True,
           GIoU=False,
           DIoU=False, CIoU=False,
           PIoU=False, eps=1e-9):
