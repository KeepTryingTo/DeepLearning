...
if __name__ == '__main__':
    ...
    evaluator = VOCAPIEvaluator(data_root=root_dir,
                                img_size=val_size,
                                device=device,
                                transform=BaseTransform(val_size))

    weight_path = r'../weights/voc/yolov3/yolov3_epoch_41_72.77.pth'
    ...
    print('MAP = {}'.format(evaluator.map))

    """
    yolov2_d19: 0.6543969392111462
    yolov3: 0.6609898034831125
    """