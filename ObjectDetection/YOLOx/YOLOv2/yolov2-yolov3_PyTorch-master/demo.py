...
def parse_args():
    ...
    parser.add_argument('--path_to_save', default='./outputs/',
    ...
    parser.add_argument('--trained_model',
                        default='./weights/voc/yolov2_d19/yolov2_d19_epoch_21_66.62.pth',
...
def detect(net, 
    ...
    class_colors = [(np.random.randint(255),
                     ...
                     np.random.randint(255)) for _ in range(len(VOC_CLASSES))]
    ...
    # ------------------------- Image ----------------------------
        ...
        for i, img_id in enumerate(os.listdir(path_to_img)):
            ...
            # print('{} inference time is {}'.format(img_id,time.time() - start_time))
