...
from models.darknet53 import YOLOv3
...
def main():
    ...
    train_path = r'/home/ff/ObjectDetect/projects/ImageNet1k_code/ImageNet_1k_0_999'
    val_path = r'/home/ff/ObjectDetect/projects/ImageNet1k_code/ImageNet_1k_0_999_test'
    ...
    model = YOLOv3(num_classes=1000).to(device)
    ...
    for epoch in range(start_epoch,epochs):
        ...
        if best_acc < val_acc:
            ...
            save_path = r'/home/ff/ObjectDetect/projects/yolov3/models/classification/darknet53/kaggle'
