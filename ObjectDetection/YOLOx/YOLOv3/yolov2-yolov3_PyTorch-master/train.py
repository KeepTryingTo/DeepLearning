...
def parse_args():
    ...
    parser.add_argument('-v', '--version', default='yolov3',
                        help='yolov2_d19, yolov2_r50, yolov2_slim, '
                             'yolov3, yolov3_spp, yolov3_tiny')
    
    # dataset
    parser.add_argument('-root',
                        '--data_root',
                        default='/home/ff/myProject/KGT/myProjects/myDataset/voc2012',
                        help='dataset root')
    ...
    # DDP train
    parser.add_argument('-dist', '--distributed',
...
def train():
    ...
    if args.dataset == 'voc':
        ...
        num_classes = 20
        dataset = VOCDetection(data_dir=args.data_root,
                                transform=SSDAugmentation(train_size))

        evaluator = VOCAPIEvaluator(data_root=args.data_root,
                                    img_size=val_size,
                                    device=device,
    ...
    for epoch in range(args.start_epoch, max_epoch):
        ...
        for iter_i, (images, targets) in enumerate(dataloader):
            ...
            if model_name in ['yolov2_d19', 'yolov2_r50']:
                #TODO 生成target[cx，cy,w,h,conf,cx,cy,w,h,conf ,cls_0,...]
