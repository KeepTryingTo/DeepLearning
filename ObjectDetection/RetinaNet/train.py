...
def main(args=None):
    ...
    parser.add_argument('--dataset', type=str,default=r'coco',
    ...
    optimizer = optim.Adam(retinanet.parameters(), lr=4e-5)
    ...
    for epoch_num in range(parser.epochs):
        ...
        for iter_num, data in enumerate(dataloader_train):
            try:
                ...
                torch.nn.utils.clip_grad_norm_(retinanet.parameters(),
                                               max_norm=0.1)
        ...
        torch.save(retinanet.state_dict(),
                   './weights/{}_retinanet_{}.pt'.format(parser.dataset, epoch_num))

    retinanet.eval()

    torch.save(retinanet.state_dict(), './weights/model_final.pt')
