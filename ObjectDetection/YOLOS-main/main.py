...
def main(args):
    ...
    # TODO fix the seed for reproducibility
    seed = args.seed + utils.get_rank()
    torch.manual_seed(seed)
    np.random.seed(seed)
    random.seed(seed)
    # TODO 定义模型 import pdb;pdb.set_trace()
    ...
    if args.dataset_file == "coco_panoptic":
        # TODO We also evaluate AP during panoptic training, on original coco DS
