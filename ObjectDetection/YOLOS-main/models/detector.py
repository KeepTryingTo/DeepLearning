...
class Detector(nn.Module):
    def __init__(self, num_classes, pre_trained=None,
                 det_token_num=100, backbone_name='tiny',
        ...
        self.backbone.finetune_det(det_token_num=det_token_num,
                                   img_size=init_pe_size,
                                   mid_pe_size=mid_pe_size,
                                   use_checkpoint=use_checkpoint)
        
        self.class_embed = MLP(input_dim=hidden_dim, hidden_dim=hidden_dim,
                               output_dim=num_classes + 1, num_layers=3)
        self.bbox_embed = MLP(input_dim=hidden_dim, hidden_dim=hidden_dim,
...
class SetCriterion(nn.Module):
    ...
    def forward(self, outputs, targets):
        ...
        # TODO Retrieve the matching between the outputs of the last layer and the targets
        indices = self.matcher(outputs_without_aux, targets)

        # TODO Compute the average number of target boxes accross all nodes, for normalization purposes
