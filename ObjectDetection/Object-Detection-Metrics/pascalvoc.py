...
parser.add_argument('-detformat',
                    ...
                    '(\'xywh\': <left> <top> <width> <height>) '
                    'or (\'xyrb\': <left> <top> <right> <bottom>)')
parser.add_argument('-gtcoords', #TODO 坐标是相对图像大小还是绝对大小
                    dest='gtCoordinates',
                    default='abs',
                    metavar='',
...
绝对坐标和相对坐标
"""
# TODO 相对坐标还是绝对坐标 Coordinates types
...
#TODO 如果是相对坐标就根据当前指定的图像转换为元组表示方法
