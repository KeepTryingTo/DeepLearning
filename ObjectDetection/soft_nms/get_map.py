...
from utiles.utils import get_classes
from utiles.utils_map import get_coco_map, get_map
from utiles.ssd_detector import SSD
...
if __name__ == "__main__":
    ...
    #   默认指向根目录下的VOC数据集
    # -------------------------------------------------------#
    VOCdevkit_path = r'E:\conda_3\PyCharm\Transer_Learning\PASCAL_VOC\VOCdevkit'
    # -------------------------------------------------------#
    #   结果输出的文件夹，默认为map_out
    # -------------------------------------------------------#
