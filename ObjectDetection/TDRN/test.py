...
parser.add_argument('--refine', default=True, type=bool, help='Only work when backbone==RefineDet')
...
parser.add_argument('--multihead', default=True, type=bool, help='Multihead detection')
...
parser.add_argument('--bn', default=False, type=bool, help='select sequence data in a skip way')
...
if __name__ == '__main__':
    ...
    # load data
    testset = VOCDetection(args.voc_root,
                           [('2007', 'test')],
