...
class VOCDetection(data.Dataset):
    ...
    def __init__(self, root, image_sets, transform,
                 target_transform, max_trans_ratio=0.1,
                 dataset_name='VOC0712', set_file_name='train',
                 seq_len=8, skip=False, use_mask=False):
        self.root = root
