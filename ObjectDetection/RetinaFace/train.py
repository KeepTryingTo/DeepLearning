...
parser.add_argument('--training_dataset', default='./data/WIDERFACE/widerface/train/label.txt',
                                                        help='Training dataset directory')
parser.add_argument('--network', default='mobile0.25', help='Backbone network mobile0.25 or resnet50')
parser.add_argument('--num_workers', default=8, type=int, help='Number of workers used in dataloading')
parser.add_argument('--lr', '--learning-rate', default=0.00025, type=float, help='initial learning rate')
...
def train():
    ...
    dataset = WiderFaceDetection( txt_path=training_dataset,
    ...
    for iteration in range(start_iter, max_iter):
        ...
        lr = adjust_learning_rate(
            ...
            iteration=iteration, epoch_size=epoch_size)
