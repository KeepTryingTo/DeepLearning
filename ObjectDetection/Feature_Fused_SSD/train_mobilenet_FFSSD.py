...
parser.add_argument('-v', '--version', default='myFeature_Fused_SSD_Mobilenet',
...
parser.add_argument('--basenet', default='./weights/mobilenet_feature.pth',
...
net = build_net('train', img_dim, num_classes,is_concat=args.is_concat)
