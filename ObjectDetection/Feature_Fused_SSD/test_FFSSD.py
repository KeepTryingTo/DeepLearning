...
from data import (AnnotationTransform, VOCDetection,
                  BaseTransform, VOC_300,VOC_512,
                  COCO_300,COCO_512, COCO_mobile_300)
...
parser.add_argument('-m', '--trained_model',
                    default='./runs/myFeature_Fused_sum_SSD_Vgg_VOC_epoches_190.pth', #Final_RFB_vgg_VOC.pth
...
if __name__ == '__main__':
    ...
    num_classes = (21, 81)[args.dataset == 'COCO']
    net = build_net('test', img_dim, num_classes,is_concat=False)    # initialize detector
...
('2007', 'trainval'), ('2012', 'trainval') and test on 2007 test.txt for vgg and concat
    iou_thresh=0.005,conf_threshod = 0.005 MAP = 0.7020
    
('2007', 'trainval'), ('2012', 'trainval') and test on 2007 test.txt for mobilenet and concat
    iou_thresh=0.005,conf_threshod = 0.005 MAP = 0.6493
    
('2007', 'trainval'), ('2012', 'trainval') and test on 2007 test.txt for vgg and element-sum
    iou_thresh=0.005,conf_threshod = 0.005 MAP = 0.7030
    
('2007', 'trainval'), ('2012', 'trainval') and test on 2007 test.txt for mobilenet and element-sum
    iou_thresh=0.005,conf_threshod = 0.005 MAP = 
"""