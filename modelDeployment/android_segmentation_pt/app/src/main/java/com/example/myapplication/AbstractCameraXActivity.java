...
public abstract class AbstractCameraXActivity extends BaseModuleActivity {
...
//                    .setTargetResolution(new Size(1344, 2992))
        ...
        imageAnalysis.setAnalyzer((image, rotationDegrees) -> {
            ...
            final Bitmap result = analyzeImage(image, rotationDegrees);
            if (result != null) {
...
//            image.close();
    ...
    @WorkerThread
    @Nullable
    protected abstract Bitmap analyzeImage(ImageProxy image, int rotationDegrees);

    @UiThread
    protected abstract void applyToUiAnalyzeImageResult(Bitmap result);
}
