...
from codes.models.GlobalAttention import GlobalAttentionGeneral as ATT_NET
...
class RNN_ENCODER(nn.Module):
    def __init__(self, ntoken, ninput=300, drop_prob=0.5,
        ...
        self.ntoken = ntoken  # TODO size of the dictionary
        self.ninput = ninput  # TODO size of each embedding vector
        self.drop_prob = drop_prob  # TODO  probability of an element to be zeroed
        self.nlayers = nlayers  # TODO Number of recurrent layers
        ...
        # TODO number of features in the hidden state
    ...
    def define_module(self):
        ...
        if self.rnn_type == 'LSTM':
            ...
            # TODO the outputs of each RNN layer except the last layer
    ...
    def forward(self, captions, cap_lens, hidden, mask=None):
        ...
        # --> emb: batch x n_steps x ninput TODO 获得词嵌入向量
        emb = self.drop(self.encoder(captions))
        # Returns: a PackedSequence object
        cap_lens = cap_lens.data.tolist()
        #TODO 对embedding根据句子长度进行padding
...
class CA_NET(nn.Module):
    # some codes is modified from vae examples
...
class G_NET(nn.Module):
    def __init__(self):
        ...
        self.ca_net = CA_NET()
        #TODO 默认的BRANCH_NUM = 3
        if cfg.TREE.BRANCH_NUM > 0:
            self.h_net1 = INIT_STAGE_G(ngf * 16, ncf)
            self.img_net1 = GET_IMAGE_G(ngf)
        # gf x 64 x 64 TODO 第二阶段
    ...
    def forward(self, z_code, sent_emb, word_embs, mask):
        ...
        fake_imgs = []
        att_maps = []
        #TODO 论文图中对应的Fca函数，对文本向量进一步编码得到重参数化的code以及均值和方差
