...
def drawCaption(convas, captions, ixtoword, vis_size, off1=2, off2=2):
    ...
    fnt = ImageFont.truetype('Pillow/Tests/fonts/FreeMono.ttf', size = 50)
...
def build_super_images(real_imgs,
    ...
    text_convas = np.ones(
        [batch_size * FONT_MAX,(max_word_num + 2) * (vis_size + 2), 3],
                dtype=np.uint8)

    #TODO 针对句子包含词最大长度指定对应文本画布的颜色
    ...
    for i in range(num):
        ...
        for j in range(num_attn):
            ...
            if (vis_size // att_sze) > 1:
                #TODO https://github.com/taoxugit/AttnGAN/issues/80
