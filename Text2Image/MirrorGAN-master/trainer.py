...
class Trainer(object):
    ...
    def build_models(self):
        ...
        # TODO 加载图像特征提取器 Caption models - cnn_encoder and rnn_decoder
        ...
        #TODO  Generator and Discriminator:
        netsD = []
        if cfg.GAN.B_DCGAN:
    ...
    def train(self):
        ...
        for epoch in range(start_epoch, self.max_epoch):
            ...
            while step < self.num_batches:
                ...
                netG.zero_grad()
                errG_total, G_logs = \
                    generator_loss(netsD, image_encoder, caption_cnn,
                                   caption_rnn, captions, fake_imgs,
                                   real_labels,
