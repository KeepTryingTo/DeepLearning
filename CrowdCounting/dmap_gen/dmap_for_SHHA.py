...
if __name__ == "__main__":
    # root_dir = r'/home/ff/myProject/KGT/myProjects/myDataset/shanghai/ShanghaiTech/part_B/test_data'
    # save_dir = r'/home/ff/myProject/KGT/myProjects/myDataset/shanghai/ShanghaiTech/part_A/DCCUS_final/test_data/npys'

    # root_dir = r'/home/ff/myProject/KGT/myProjects/myDataset/shanghai/ShanghaiTech/part_A/train_data'
    # save_dir = r'/home/ff/myProject/KGT/myProjects/myDataset/shanghai/ShanghaiTech/part_A/DCCUS_final/train_data/npys'
    #
    # root_dir = r'/home/ff/myProject/KGT/myProjects/myDataset/shanghai/ShanghaiTech/part_A/train_data'
    # save_dir = r'/home/ff/myProject/KGT/myProjects/myDataset/shanghai/ShanghaiTech/part_A/train_data/npys'
    ...
    image_file_list = os.listdir(os.path.join(root_dir, 'images'))
    for image_file in tqdm(image_file_list):
        ...
        np.save(os.path.join(save_dir,image_file.replace('.jpg','.npy')),densitymap)
